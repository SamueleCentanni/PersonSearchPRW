...
> [!NOTE]
> The best way to execute the project is by opening it on **Google Colab** and playing around with it. The jupiter notebook is based on the **MLCV** folder, which contains the python scripts.

<!-- TOC --><a name="model-weights"></a>
## Model Weights
The final weights of the three models are in this [folder](https://liveunibo-my.sharepoint.com/:f:/g/personal/samuele_centanni_studio_unibo_it/IgDll3QLJKl7QpgAYB-YxUGdAUYFoVoTZKElzj9W-Wfou_Y).
